...
/**
 * Created by Alumno-J on 14/06/2017.
 */

class PreferencesHelper {
    private static final String PERSONAS_PREFERENCES = "mynotesPreferences";
    private static final String PREFERENCES_USERNAME = PERSONAS_PREFERENCES + ".username";
    private static final String PREFERENCES_PASSWORD = PERSONAS_PREFERENCES + ".password";
    ...
    private static SharedPreferences getSharedPreferences(Context context) {
        return context.getSharedPreferences(PREFERENCES_PASSWORD, Context.MODE_PRIVATE);
    }
}
